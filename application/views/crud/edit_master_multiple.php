        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Ubah Data Master Multiple</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <form id="basic">
                        <div class="card-body">
                            ...
                            <div class="form-group" style="text-align-last: right; margin-bottom: 0px">
                                ...
                                <button type="button-submit" onclick="edit(<?php echo $data->idMasterMultiple ?>)" class="btn btn-primary text-white">
                                    Simpan
                                </button>
                            </div>
                        </div>
        ...
        $("#basic").submit(function(e) {
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: "POST",
                        url: baseUrl + "C_crud/update_master_multiple/" + id,
