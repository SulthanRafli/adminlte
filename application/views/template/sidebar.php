<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="<?php echo base_url('C_home/dashboard_v3') ?>" class="brand-link">
        <img src="<?php echo base_url('assets/') ?>dist/img/logo.png" alt="logo" class="brand-image img-circle elevation-3" style="opacity: 0.8" />
        <span class="brand-text font-weight-light" style="font-size: 1rem; vertical-align: text-top;">Database Permata Bekasi</span>
    </a>
